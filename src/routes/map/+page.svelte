<script lang="ts">
	...
	import { dusun } from '$lib/data/village';
...
<section class="w-full px-6 pt-24 pb-20 md:px-16 md:pt-28 md:pb-28 lg:px-24">
	<div class="mx-auto max-w-6xl">
		...
		<div class="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-12">
			...
			<div class="flex flex-col gap-3 lg:col-span-4">
				...
				>
					...
					<dd class="mt-1 font-serif text-xl text-ink italic">218&ndash;394 mdpl</dd>
				</div>
				<div
				...
				>
					...
					<dd class="mt-1 font-serif text-xl text-ink italic">
						6&deg;36'37" LS, 107&deg;22'39" BT
					</dd>
				</div>
				{#each dusun as d, i (d.nama)}
					<div
		...
		>
			...
			<a
				href="https://www.google.com/maps?q=-6.6102544,107.3774396"
				target="_blank"
