...
<section class="w-full px-6 pt-24 pb-20 md:px-16 md:pt-28 md:pb-28 lg:px-24">
	<div class="mx-auto max-w-5xl">
		...
		<div use:reveal class="reveal-up mt-16 grid grid-cols-1 gap-10 md:grid-cols-12">
			...
			<div class="md:col-span-8">
				<p class="text-sm leading-relaxed text-ink-soft md:text-base">
					Desa Cipicung pada awalnya merupakan bagian dari Desa Sukamaju. Seiring pemekaran wilayah,
					Cipicung berdiri sebagai desa tersendiri dengan Sukamaju sebagai desa induk.
				</p>
				...
				<div class="mt-8 flex flex-col divide-y divide-ink/15 border-t border-ink/15">
					{#each [{ periode: '2013 — sekarang', nama: 'Lili Sadili' }, { periode: '2007 — 2013', nama: 'Edi Supriadi' }, { periode: '2000 — 2007', nama: 'Muhidin' }, { periode: '1987 — 1999', nama: 'Asep Hidayat' }, { periode: '1983 — 1987', nama: 'Mahpudin' }] as k, i (i)}
						<div
		...
		<div use:reveal class="reveal-up mt-16 border-t border-ink/15 pt-16">
			...
			<div class="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-12">
				...
				<div class="lg:col-span-5">
					<p class="text-sm leading-relaxed text-ink-soft md:text-base">
						Desa Cipicung berada di sisi barat Kecamatan Sukatani, berjarak sekitar 5 km dari kantor
						kecamatan dan 15 km dari pusat Kabupaten Purwakarta. Wilayahnya berupa perbukitan pada
						ketinggian 218&ndash;394 mdpl, terbagi menjadi dua dusun:
					</p>
					<ul class="mt-4 space-y-2 text-sm leading-relaxed text-ink-soft md:text-base">
						<li><span class="text-ink">Dusun I</span> &mdash; 214,05 Ha, 2 RW / 5 RT.</li>
						<li><span class="text-ink">Dusun II</span> &mdash; 205,95 Ha, 2 RW / 6 RT.</li>
					</ul>
					...
					<dl class="mt-8 grid grid-cols-2 gap-x-8 gap-y-4 border-t border-ink/15 pt-6 font-mono">
						<div>
							...
							<dd class="mt-1 text-sm text-ink">Tajur Sindang, Sukamaju</dd>
						</div>
						<div>
							<dt class="text-[11px] tracking-[0.15em] text-ink-soft uppercase">Timur</dt>
							<dd class="mt-1 text-sm text-ink">Cilalawi, Sukamaju</dd>
						</div>
						<div>
							<dt class="text-[11px] tracking-[0.15em] text-ink-soft uppercase">Selatan</dt>
							<dd class="mt-1 text-sm text-ink">Linggunung, Pamoyanan</dd>
						</div>
						<div>
							<dt class="text-[11px] tracking-[0.15em] text-ink-soft uppercase">Barat</dt>
							<dd class="mt-1 text-sm text-ink">Sukamulya, Sindanglaya</dd>
						</div>
					</dl>
		...
		>
			...
			<div class="md:col-span-8">
				<h2 class="font-serif text-2xl leading-snug italic md:text-3xl">
					&ldquo;Terwujudnya Desa Cipicung yang lebih maju, berprestasi, berbudaya, dan kreatif
					melalui peningkatan sumber daya manusia, pengelolaan sumber daya alam, serta pemantapan
					pembangunan berlandaskan keagamaan, kultural, dan budaya daerah.&rdquo;
				</h2>
		...
		>
			...
			<div class="md:col-span-8">
				<p class="text-sm leading-relaxed text-ink-soft md:text-base">
					Sebagian besar wilayah Cipicung berupa perbukitan, sehingga mata pencaharian warga
