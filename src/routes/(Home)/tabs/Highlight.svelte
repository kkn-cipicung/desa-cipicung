<div class="w-full py-4 md:py-12 h-full flex flex-col justify-center">
	<div class="w-full flex flex-col items-center">
		<!-- Header with padding -->
		<div class="text-center max-w-2xl mb-8 space-y-2 md:space-y-4 px-6 md:px-12 lg:px-24">
			<h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground">Highlight UMKM</h2>
			<p class="text-base md:text-lg text-muted-foreground leading-relaxed">
				Produk unggulan karya masyarakat Desa Mandiri, mendukung kemajuan ekonomi lokal.
			</p>
		</div>
		...
		<div class="w-full">
			...
			>
				...
				>
					<div class="w-full h-40 md:h-48 bg-muted shrink-0">
						<img src="/gulaaren.jpg" alt="Gula Aren" class="w-full h-full object-cover" />
					</div>
					<div class="p-4 md:p-6 flex flex-col flex-grow space-y-2 md:space-y-4">
						...
						<a
							href="/katalog/kopi"
							class="text-primary font-semibold text-xs md:text-sm hover:underline flex items-center gap-1 mt-auto"
						>
							Lihat Detail &rarr;
						</a>
					</div>
				...
				>
					<div class="w-full h-40 md:h-48 bg-muted shrink-0">
						<img src="/tusuksate.jpg" alt="Tusuk Sate" class="w-full h-full object-cover" />
					</div>
					<div class="p-4 md:p-6 flex flex-col flex-grow space-y-2 md:space-y-4">
				...
				>
					<div class="w-full h-40 md:h-48 bg-muted shrink-0">
						<img src="/arang.jpg" alt="Arang Briket" class="w-full h-full object-cover" />
					</div>
					<div class="p-4 md:p-6 flex flex-col flex-grow space-y-2 md:space-y-4">
